...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { name: "description", content: "BK Studio designs content-driven booking systems for hotels, boutique accommodations, luxury Airbnb operators, and travel brands." },
      { property: "og:title", content: "BK Studio — Hospitality Growth Systems" },
      { property: "og:description", content: "Content. Booking systems. CRM. Automation. Communities. Everything working together." },
